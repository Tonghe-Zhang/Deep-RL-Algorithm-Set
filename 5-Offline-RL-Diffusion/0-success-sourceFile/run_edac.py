...
from utils import gta_to_data, to_transitions
...
def train(args=get_args()):
    ...
    #dataset=to_transitions(gta_to_data("./halfcheetah-medium-replay-v0-weighted.npz", first_time_load=False))
    
    dataset=gta_to_data("./halfcheetah-medium-replay-v0-weighted.npz", first_time_load=False)
